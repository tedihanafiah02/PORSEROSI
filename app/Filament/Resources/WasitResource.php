...
use App\Filament\Resources\WasitResource\Pages;
...
class WasitResource extends Resource
{
    ...
    protected static ?string $pluralModelLabel = 'Data Wasit';

    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()->where('kategori', 'Wasit');
    }
    ...
    {
        return [
            'index' => Pages\ListWasits::route('/'),
            'create' => Pages\CreateWasit::route('/create'),
            'edit' => Pages\EditWasit::route('/{record}/edit'),
        ];
    }
}
